...
if __name__ == "__main__":
    ...
    from src.features.pipeline import load_cleaned
    train_df = load_cleaned("BTC/USDT", "1h", processed_dir="data/processed")

    from src.features.price      import price_features
    ...
    train_df = price_features(train_df)
    train_df = momentum_features(train_df)
    train_df = volume_features(train_df)
    train_df = volatility_features(train_df)
    train_df = temporal_features(train_df)

    plot_features(train_df, out_dir="graphs")
